...
Room4::Room4(float gWidth, float gHeight, float gDepth, float g)
{
	...
	mrBean->position = { 0.0f, 0.0f, 0.0f };
	addChild(mrBean);

	Model* teddy = new Model("assets/models/british_leyland_mini/scene.gltf");
	teddy->scale = { 1.0f, 1.0f, 1.0f };
	teddy->position = { 3.0f, 5.0f, 5.0f };
